...
export class SubmitFinlandAttributesComponent implements OnInit {
   ...
   */
  createFormControls() {
    this.documentNumber = new FormControl(SubmitFinlandAttributesComponent.randomNumeric(9), Validators.required);
    this.personalNumber = new FormControl(SubmitFinlandAttributesComponent.randomNumeric(10), Validators.required);
    ...
    this.nationality = new FormControl("FIN", Validators.required);
    ...
    this.jurisdictionId = new FormControl("MNOA", Validators.required);
